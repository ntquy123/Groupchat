...
<html>
  ...
  <body>
    ...
    <?php
                ...
                $queryCount = "SELECT COUNT(*) as total FROM Group_Master";
                $query = "SELECT a.*,b.Name as NameTypeGroup FROM Group_Master a
                          JOIN  System_General_Detail b on a.Type=b.Cate
                            ";
                $category="all";
                $urlpage="?menu=listgroup";
                if (isset($_GET['category'])&&$_GET['category']!="all") {
                  $category = $_GET['category'];
                  $query .= " WHERE Type = '$category'";
                  $queryCount .= " WHERE Type = '$category'";
                  $urlpage.="&category=$category";
              }
               if (isset($_GET['tag'])&&$_GET['tag']!="all") {
                  $tag = $_GET['tag'];
                  $query .= " WHERE Tag = '$tag'";
                  $queryCount .= " WHERE Tag = '$tag'";
                  $urlpage.="&tag=$tag";
              }
                $resultCount = showData($queryCount);
                $totalItems =0;
                if ($resultCount && isset($resultCount[0]['total'])) {
                    $totalItems = $resultCount[0]['total'];
                }
                $itemsPerPage = 9;
                if (isset($_GET['page'])) {
                ...
                $queryTag = "SELECT * FROM System_General_Detail Where Type_Cate=$Tag_Group";
                $dataTag = showData($queryTag);
?>
          ...
          <div class="row">
            <div class="text-center padding-medium no-padding-bottom">
              ...
              <div class="breadcrumbs">
                ...
                <span class="item">List Group</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <main class="col-md-9">
            <div class="filter-shop d-flex flex-wrap justify-content-between">
              <div class="showing-product">
                <p>Showing 1-9 of <?php echo  $totalItems  ?> results</p>
              </div>
              <div class="sort-by">
                <select id="input-sort" class="form-control" data-filter-sort="" data-filter-order="">
                  ...
                  <option value="">View (Low-High)</option>
                  <option value="">View (High-Low)</option>
             ...
             if ($data) {
              ...
              <div class="col-lg-4 col-md-6">
                <div class="product-card mb-4">
                  ...
                  <img style="width: 300px; height: 300px; object-fit: cover;" src="<?php echo $row['Image1']; ?>" alt="product-item" class="img-fluid">
                  ...
                  <div class="card-detail text-center pt-3 pb-2">
                    ...
                    <span class="item-price text-primary fs-4"><?php  echo $row['NameTypeGroup']  ?>  View: <?php  echo $row['View']  ?></span>
                    <div class="cart-button mt-1">
                      <a href="<?php  echo $row['Link']  ?>" target="_blank" class="btn">Join Group</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <nav class="navigation paging-navigation text-center padding-medium" role="navigation">
              <div class="pagination loop-pagination d-flex justify-content-center align-items-center">
                <?php
                  if ($currentPage > 1) {
                ?>
                <a href="<?php echo $urlpage ?>&page=<?php echo $currentPage -1?>" class="d-flex pe-2">
                  ...
                  for ($page = 1; $page <= $totalPages; $page++)
                   {
                    ...
                    {
                ?>
                      <span aria-current="page" class="page-numbers current pe-3"><?php echo $page ?></span>
                <?php
                    }
                    else
                    {
                ?>
                     <a class="page-numbers pe-3" href="<?php echo $urlpage ?>&page=<?php echo $page ?>"><?php echo $page ?></a>
                ...
                <a href="<?php echo $urlpage ?>&page=<?php echo $currentPage +1?>" class="d-flex ps-2">
            ...
            <div class="sidebar">
              ...
              <div class="widget-product-categories pt-5">
                ...
                <ul class="product-categories sidebar-list list-unstyled">
                  <li class="cat-item">
                    <a href="?menu=listgroup&category=all">All</a>
                  </li>
                  <?php
                  if ($datacategory) {
                    ...
                    ?>
                  <li class="cat-item">
                    <a href="?menu=listgroup&category=<?php echo $row['Cate']  ?>"><?php  echo $row['Name']  ?></a>
                  </li>
                          <?php
              ...
              <div class="widget-product-tags pt-3">
                ...
                <ul class="product-tags sidebar-list list-unstyled">
                  <li class="tags-item">
                    <a href="?menu=listgroup&tag=all">All</a>
                  </li>
                  <?php
                  if ($dataTag) {
                    ...
                    ?>
                   <li class="tags-item">
                    <a href="?menu=listgroup&tag=<?php echo $row['Cate']  ?>"><?php  echo $row['Name']  ?></a>
                  </li>
                          <?php
